...
odir = paste0("fastqs_GSE69239_careo_for_bcell_dev")
dir.create(odir)
...
dt[, c("cell", 'rep') := tstrsplit(title, " ", keep = c(1, 3))]

dt[, file_name := paste(paste0(cell, "_rep", rep), gsm, srr, "fastq", sep = ".")]
