...
odir = paste0("fastqs_", gse, "_Schjerven_Ikaros_Thymocytes")
dir.create(odir)
odir = normalizePath(odir)
setwd(odir)


dt$name = c("Schjerven_thymus_c3_wt_Ikaros", 
            "Schjerven_thymus_c3_DF1_Ikaros",
            "Schjerven_thymus_c5_DF1_Ikaros",
            "Schjerven_thymus_c5_DF4_Ikaros",
            "Schjerven_thymus_na_wt_input",
            "Schjerven_thymus_c5_wt_Ikaros")
