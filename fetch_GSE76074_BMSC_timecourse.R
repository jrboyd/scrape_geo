...
library(data.table)
gse = "GSE76074" #will be combined with GSE19465
...
odir = paste0(gse, "_hm_and_tf_in_BMSC_timecourse")
dir.create(odir)
setwd(odir)
...
dt[, Title := sub("_R", "_rep", Title)]
dt[, file_name := paste0(Title, ".fastq" )]
dt[, file_name := sub("BMSC_", "BMSC-", file_name)]
