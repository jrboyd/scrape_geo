...
gse = "GSE63018" #will be combined with GSE19465
chara = list("patient id", "patient age", "patient sex")
...
dt[, rep := seq(.N), by = .(`patient id`)]
dt[, file_name := paste0(paste("patient", `patient id`, id, paste0("R", rep), gsm, sep = '_'), ".fastq")]
